define(['base/js/namespace','base/js/events','nbextensions/ma/side_comments/side-comments-ws',
  'nbextensions/ma/side_comments/side-comments-helper', 'exports'], function(IPython, events, ws, helper, exports) {
        var sectionIDs = [];
