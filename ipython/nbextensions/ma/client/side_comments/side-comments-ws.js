define(['exports','nbextensions/gdrive/drive_utils',
'nbextensions/gdrive/gapi_utils'],
function(exports,driveutils,gapiutils) {
  var websocket = new WebSocket("ws://77.59.137.184:8888/comments");

  $("body").append($("<script src='/nbextensions/ma/client/side_comments/side-comments.js'></script>"));
